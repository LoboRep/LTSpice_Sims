(function () {
  ...
  window.adroll_seg_eid = "2RRZU4E6QRGA7JXM7YFP7J";
...
(function() {
  ...
  if (window === window.top && ua.indexOf('safari') !== -1 && ua.indexOf('chrome') === -1 && ua.indexOf('crios') === -1) {
    ...
    b.src = '//d.adroll.com/bounce/pre/NUEMRECMLVAATNHNFMTRX6/O37SCF3KTFDCHKEGCW6XFQ/?d=' + encodeURIComponent('//s.adroll.com/j/bounce.js');
...
rtb.innerHTML = ["/cm/b/out?advertisable=NUEMRECMLVAATNHNFMTRX6","/cm/g/out?advertisable=NUEMRECMLVAATNHNFMTRX6","/cm/index/out?advertisable=NUEMRECMLVAATNHNFMTRX6","/cm/l/out?advertisable=NUEMRECMLVAATNHNFMTRX6","/cm/n/out?advertisable=NUEMRECMLVAATNHNFMTRX6","/cm/o/out?advertisable=NUEMRECMLVAATNHNFMTRX6","/cm/outbrain/out?advertisable=NUEMRECMLVAATNHNFMTRX6","/cm/pubmatic/out?advertisable=NUEMRECMLVAATNHNFMTRX6","/cm/r/out?advertisable=NUEMRECMLVAATNHNFMTRX6","/cm/taboola/out?advertisable=NUEMRECMLVAATNHNFMTRX6","/cm/triplelift/out?advertisable=NUEMRECMLVAATNHNFMTRX6","/cm/x/out?advertisable=NUEMRECMLVAATNHNFMTRX6"].reduce(function (acc, cmURL) {
...
(function(d) {
    ...
    for(var i=0;i < ca.length;i++) {
        ...
        if (c.indexOf(cn) == 0) {
            l = "<img height=\"1\" width=\"1\" style=\"border-style:none;\" alt=\"\" src=\"https://d.adroll.com/cm/mk/NUEMRECMLVAATNHNFMTRX6/in?id=[mk_id]\"/>";
    ...
    fbq('init', '805397282885671');
    fbq('set', 'autoConfig', 'false', '805397282885671');
    __adroll.fb=true;

    var __fbcd = {segment_eid: "2RRZU4E6QRGA7JXM7YFP7J"};
    ...
    var __fbcd = {event: "EventSegment", segment_eid: "2RRZU4E6QRGA7JXM7YFP7J"};
    for (var prop in __adroll.get_external_data()){
        __fbcd['ar_' + prop] = __adroll.get_external_data()[prop];
    }
  ...
  if (typeof __adroll.set_pixel_cookie != 'undefined') {__adroll.set_pixel_cookie(adroll_adv_id, adroll_pix_id, "2RRZU4E6QRGA7JXM7YFP7J");}
}());
